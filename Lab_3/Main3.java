...
public class Main3 extends JFrame {
    ...
    public Main3(Double[] coefficients) {
        ...
        Action searchValueAction = new AbstractAction("Найти значение многочлена") {
            public void actionPerformed(ActionEvent event) {
                String value = JOptionPane.showInputDialog(
                        Main3.this, "Введите значение для поиска", "Поиск значения", JOptionPane.QUESTION_MESSAGE);
        ...
        Action searchSimpleAction = new AbstractAction("Найти близкие к простым") {
            public void actionPerformed(ActionEvent event) {
                renderer.setSimpleFlag(true);
                getContentPane().repaint();
            }
        };
        searchSimpleItem = tableMenu.add(searchSimpleAction);
        ...
        AboutProgram = helpMenu.add(openAboutProgram);
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                data = new GornerTableModel(from, to, step, Main3.this.coefficients);
                ...
                searchSimpleItem.setEnabled(true);
                    ...
                    JOptionPane.showMessageDialog(Main3.this, "Ошибка в формате записи числа с плавающей точкой", "Ошибочный формат числа", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
    ...
    public static void toStart(String[] args) {
        ...
        Main3 frame = new Main3(coefficients);
